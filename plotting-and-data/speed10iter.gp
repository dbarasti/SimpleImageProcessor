...
unset ttics
set title "Speedup for 300 images (10 iter)"
...
plot for [IDX=0:1] "data/benchmark-10.txt" i IDX u 1:(seq10iter/$2) title columnheader(1) w lines smooth bezier, f(x) t "ideal"
#    EOF