...
unset ttics
set title "Scalability for 300 images (10 iter)"
...
GNUTERM = "qt"
GPFUN_f = "f(x) = x"
array scal10iter[2] = [61203,61407]
## Last datafile plotted: "benchmark-10.txt"
plot for [IDX=0:1] "data/benchmark-10.txt" i IDX u 1:(scal10iter[IDX+1]/$2) title columnheader(1) w lines smooth bezier, f(x) t "ideal"
